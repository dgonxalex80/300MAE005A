...
|:----------------|:------------------------------------------------------------------------|
|**Actividad 331**| Construir un poster en formato A1 (59,4 cm x 84 cm).  para el modelo asignado que contenga sus principales características   |
|                 | Trabajo enindividual                              |
|Fecha entrega    | 27 de marzo de 2025 - **Presentación oral del poster**                  |
|Hora             | 9:00                                                                  |
...
|                |                                                                         | 
|:---------------|:------------------------------------------------------------------------|
|**Activiad 332**| Cada estudiante deberá seleccionar un problema dentro de los primeros tres enunciados presentados en la Actividad332. Además del problema seleccionado deberá también realizar de forma obligatoria el Problema 4. En total debe presentar dos problemas (el problema seleccionado y el problema 4).                   | 
|               | Trabajo individual                                                       |
...
|Actividad      | Descripción                             | 
|:--------------|:----------------------------------------|
|Actividad 331  | poster impreso y presentación del mismo. Jueves 27 de marzo. Hora: 9:00
|Actividad 332  | enlace de Rmd publicado en **RPub** con el desarrollo del problema asignado. Domingo 30 de marzo. Hora : 23:59 |
