...
<div class="label">Intervalo de confianza para una media, varianza conocida</div>
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para una media</div>
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para una media, con tamaños de muestra grandes</div>
...
<div class="box1 with-label">
<div class="label">Tamaño de muestra para la estimación de una media</div>
...
$$n = \dfrac{2.3263482^{2} \times \hspace{.2cm} 352.2}{1^{2}} = 1906.07 \sim 1906$$
Se debe tomar una muestra de 1906 dias y recoger en cada uno de ellos el número de personas muertas
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para la estimación de una proporción</div>
...
De acuerdo con el resultado anterior, se puede afirmar con una confianza del 95% que entre el 63.7% y el 72.0% de las familias tienen una suscripción a Plus-Video.  Esto daría a pensar que una gran mayoria de los hogares en la ciudad tienen esta afiliación
...
* Objetivo : Analizar la propuesta realizada por la firma externa
  ...
  $$ n = \dfrac{2.575829^{2} \hspace{.3cm} 0.5 \times 0.5}{0.05^{2}} = \dfrac{1.658724}{0.0025} = 663.4897 \sim 664$$
  
El cálculo lo podemos realizar con la función: `sizemu`  contenida en el paquete  `paqueteDEG` 
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para una varianza</div>
...
cat("n :", length(ecopetrol), "\n")
cat("P2.5  : ", qchisq(0.025, 201) , "\n")
cat("P97.5 : ", qchisq(0.975, 201), "\n")

var(ecopetrol)
```


$$IC_{\sigma^{2}}: \Bigg( \displaystyle\frac{(202-1) \times 203.0862}{242.1559}
\hspace{.3cm}; \hspace{.3cm}
\displaystyle\frac{(202-1) \times 203.0862 }{163.63} \Bigg)$$

$$\dfrac{40820.33}{242.1559}
\hspace{.3cm}; \hspace{.3cm} 
\dfrac{40820.33}{163.63}$$
$$(168.5705 
\hspace{.3cm}; \hspace{.3cm}
249.4673)$$
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para la diferencia de medias pareadas</div>
...
$$\Bigg(3.457143 - 2.446912  \hspace{.3cm} \dfrac{2.869876}{\sqrt{7}} 
\hspace{.3cm}; \hspace{.3cm}
3.457143 + 2.446912 \hspace{.3cm} \dfrac{2.869876}{\sqrt{7}}\Bigg)$$
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para diferencia de medias grupos independientes, varianzas iguales</div>
...
boxplot(inf.fin, las=1, col=c4, ylim=c(3,7))
```
...
<div class="box1 with-label">
<div class="label">Diferencia de medias, poblaciones independientes, varianzas diferentes</div>
...
<div class="box1 with-label">
<div class="label">Intervalo de confianza para la diferencia de proporciones</div>
...
<div class="box1 with-label">
<div class="label">Comparación de varianzas</div>
...
```{r, fig.align='center'}
hist(mx, las=1, main="Método 1", ylab = " ", xlab = " ", col=c3, 
     xlim = c(4.0, 7.0))
abline(v=ic1, col=c1)
```
...
```{r, fig.align='center'}
hist(mx, las=1, main="Método 2", ylab = " ", xlab = " ", col=c3, 
     xlim = c(4.0, 7.0))
abline(v=ic2, col=c6)
```
...
<div class="box3 with-label">
<div class="label">Grados de libertad</div>
...
<div class="box3 with-label">
<div class="label">Formulario : Intervalos de confianza</div>
...
<div class="box3 with-label">
<div class="label">Formulario . Tamaño de muestra</div>
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
# Copia y pega el enlace del video de YouTube aquí:
url <- "https://www.youtube.com/embed/t02nQxU14qY"
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
# Copia y pega el enlace del video de YouTube aquí:
url <- "https://www.youtube.com/embed/WbdHh7Chk_s"
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
# Copia y pega el enlace del video de YouTube aquí:
url <- "https://www.youtube.com/embed/eDOjNa6HtS0"
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
# Copia y pega el enlace del video de YouTube aquí:
url <- "https://www.youtube.com/embed/Z39sBZgxsTA"
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
# Copia y pega el enlace del video de YouTube aquí:
url <- "https://www.youtube.com/embed/eZB9PM3SsZ0"
...
re-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
 knitr::include_graphics("img/tutorial421.png")
```
