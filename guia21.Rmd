...
|:--------------|:-----------------------------  |
| Actividad 211 | **Actividad211**.  Resuelva las preguntas del siguiente  taller y entregue su solución  en formato **pdf**  en el enlace correspondiente de Brightspace.|
...
El **Actividad211** de la unidad 2.1 recoge los elementos estudiados y por tanto  tiene objetivo la revisión de los principales conceptos tratados.
