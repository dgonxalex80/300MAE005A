...
author: "dgonzalez "
subtitle: <span style="color:#2C5697">**Módulo 4- Unidad 4.2**</span> 
output:
  html_document:
    toc: no
    toc_depth: 2
...
La presente  unidad será desarrollada del 21 al 25  abril de 2025 . Ademas del material suministrado  contaran con el acompañamiento del profesor durante las sesiones de clase  y de la monitora en las actividades académicas. Los entegables para esta unidad podrán enviarse a través de la plataforma Brightspace hasta el  27 de abril de 2025 
...
* Taller 421.  En parejas deberán desarrollar el taller 421 que contiene problemas relacionados con la estimación de **intervalos de confianza** para la media, varianza, proporción, diferencia de medias,diferencia de proporciones y razón de varianzas


* Para el desarrollo de este taller se recomienda: 

  * Ver los videos contenidos `recursos 4.2`
  * Realizar los **tutoriales** con tenidos en el paquete `paqueteDEG`- revisar indicaciones en `recursos 4.2` -
